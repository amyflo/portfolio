      ...
      <Navigation/>
        ...
        <Box
         p={1} bg="blue">
            ...
            <Heading as="h1" m={[1, 4]}>She graduated from Stanford with a bachelor's degree in Psychology ('24). Pursuing a master's degree in Computer Science, Human-Computer Interaction ('25). UX Design intern @ Amazon, Summer 2024.</Heading>
